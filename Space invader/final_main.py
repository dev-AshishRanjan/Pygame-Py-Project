...
#game_over_text
over_font=pygame.font.Font("dragons.ttf",144)
over_font2=pygame.font.Font("font2.ttf",64)
def game_over_text():
    over_img=over_font.render("B",True,(255,255,255))
    over_text=over_font2.render("Game Over",True,(255,255,255))
    #over_score=over_font2.render(" Score : "+ str(pos_value) ,True,(255,255,255))
    screen.blit(over_img, (250,200))
    screen.blit(over_text, (250,350))
    #screen.blit(over_score, (200,400))
    #mixer.music.load("game_over2.wav")
    #mixer.music.play(-1)
...
while running:
    ...
    #game over
    for i in range(num):
        if enemyY[i] >= 400 and enemyX[i] >= 400 :
            for j in range(num):
                enemyY[j] =2000
            game_over_text()
            break
